...
public class CreatingVariables {
    public static void main( String[] args)
    {
        ...
        System.out.println("The value " + y + " is sotred in the variable y");
        System.out.println("The experiment complete in " + seconds + " seconds.");
        System.out.println("My fovorite irrational number is Euler's constant: " + e);
